...
class TestToolHintEdgeCases:
    ...
    def test_list_dir_registered(self):
        ...
        # Not /tmp: abbreviate_path() shortens anything under $HOME to "~", and
        # a test runner with HOME=/tmp turned this into "ls ~".
        result = _hint([_tc("list_dir", {"path": "/srv/data"})])
        assert result == "ls /srv/data"
