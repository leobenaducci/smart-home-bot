...
def test_openai_compat_preserves_message_level_reasoning_fields() -> None:
    ...
    # Emptied, and specifically to "" rather than None: Together rejects a
    # null here on openai/gpt-oss-20b with 400 "Input validation error".
    # See the note in openai_compat_provider._sanitize.
