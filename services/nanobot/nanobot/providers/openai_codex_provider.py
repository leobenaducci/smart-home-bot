...
async def _request_codex(
    ...
    # A custom CA bundle may be needed in corporate or self-signed environments;
    # certificate verification itself is never disabled.
    ca_bundle = os.environ.get("NANOBOT_CODEX_CA_BUNDLE")
