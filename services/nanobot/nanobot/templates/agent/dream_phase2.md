...
{% if write_skills %}- [SKILL] entries: create a new skill under skills/<name>/SKILL.md using write_file
{% else %}- [SKILL] entries: do NOT create skills. Skills are standing instructions and are written by people; note the idea in memory/MEMORY.md under "Ideas for skills" instead, one line each.
{% endif %}
## File paths (relative to workspace root)
- SOUL.md
- USER.md
- memory/MEMORY.md
{% if write_skills %}- skills/<name>/SKILL.md (for [SKILL] entries only)
{% endif %}
Do NOT guess paths.
...
{% if write_skills %}## Skill creation rules (for [SKILL] entries)
