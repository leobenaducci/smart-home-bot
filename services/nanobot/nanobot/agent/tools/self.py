...
class MyTool(Tool):
    ...
    def description(self) -> str:
        base = (
            ...
            "\n"
            "When to use:\n"
            "- User asks about your settings or token usage → check that key.\n"
            "  NOT which model is answering: `model` here is the configured default, "
            "and the turn may be routed elsewhere. That is the Runtime Context `Model:` line.\n"
